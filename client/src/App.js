...
const SERVER = "https://server-ticketera-bd-2.herokuapp.com/"
...
function App() {
  ...
  const getTickets = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS}`)
  ...
  const getTicketsFix = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_FIX}`)
    const data = await api.json();
  ...
  const getTicketsServicios = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_SERVICIOS}`)
    const data = await api.json();
  ...
  const getTicketsAltaPrioridad = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_HIGH_PRIORITY}`)
    const data = await api.json();
  ...
  const getTicketsAltaPrioridadTech = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_HIGH_PRIORITY_TECH}`)
    const data = await api.json();
  ...
  const getTicketsAltaPrioridadMasViews = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_HIGH_PRIORITY_VIEWS}`)
    const data = await api.json();
  ...
  const getTicketsBajaPrioridad = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_LOW_PRIORITY}`)
    const data = await api.json();
  ...
  const getTicketsValid = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_VALID}`)
    const data = await api.json();
  ...
  const getTicketsClosed = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_CLOSED}`)
    const data = await api.json();
  ...
  const getTicketsActive = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_ACTIVE}`)
    const data = await api.json();
  ...
  const getTicketsNonTechValid = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_NON_TECH_VALID}`)
    const data = await api.json();
  ...
  const getTicketsByCustomer = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_BY_CUSTOMER}`)
    const data = await api.json();
  ...
  const getTicketsEquipo = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_EQUIPO}`)
    const data = await api.json();
  ...
  const getTicketsDescriptionType = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_DESCRIPTION}`)
    const data = await api.json();
  ...
  const getTicketsChangeSoporte = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_ALL_CHANGE}`)
    const data = await api.json();
  ...
  const getTicketsByTags = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_BY_TAGS}`)
    const data = await api.json();
  ...
  const getTicketsAvgViews = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_AVG_VIEWS}`)
    const data = await api.json();
  ...
  const getTicketsLess10Views = async () =>{
    const api = await fetch(`${SERVER}${GET_TICKETS_LESS_10_VIEWS}`)
    const data = await api.json();
  ...
  const getCustomersAvellanedaSuperPack = async () =>{
    const api = await fetch(`${SERVER}${GET_CUSTOMERS_AVELLANEDA_SUPERPACK}`)
    const data = await api.json();
  ...
  const getCustomersCentroPasteur = async () =>{
    const api = await fetch(`${SERVER}${GET_CUSTOMERS_CENTRO_PASTEUR}`)
    const data = await api.json();
  ...
  const getCustomersOnDemand = async () =>{
    const api = await fetch(`${SERVER}${GET_CUSTOMERS_SERVICIO_ONDEMAND}`)
    const data = await api.json();
  ...
  const getCustomersExtraSports = async () =>{
    const api = await fetch(`${SERVER}${GET_CUSTOMERS_EXTRA_SPORTS}`)
    const data = await api.json();
  ...
  const getCustomersThreeOndemand = async () =>{
    const api = await fetch(`${SERVER}${GET_CUSTOMERS_THREE_ONDEMAND}`)
    const data = await api.json();
  ...
  const getCentersMore40Staff = async () =>{
    const api = await fetch(`${SERVER}${GET_CENTERS_MORE_40_STAFF}`)
    const data = await api.json();
  ...
  const getCentersLess30Staff = async () =>{
    const api = await fetch(`${SERVER}${GET_CENTERS_LESS_30_STAFF}`)
    const data = await api.json();
